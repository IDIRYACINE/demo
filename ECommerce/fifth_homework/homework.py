...
sales_profit.plot(kind='bar', figsize=(12, 6))
...
df[['Shipping_Cost', 'Profit']].hist(figsize=(10, 5))
...
device_order_priority = df.groupby(['Device_Type', 'Order_Priority'])['Order_ID'].count()
device_order_priority.plot(kind='bar', figsize=(10, 5))
...
category_product_sales.plot(kind='bar', figsize=(10, 5))
